...
-   **Start building a new classVars.csv**\
    [Open App](https://kratos-shiny.umontana.net/cel-apps/cdmetapopR/classvars/){.btn .btn-primary target="_blank"}

<!-- -->

-   **Start building a new patchVars.csv**\
    [Open App]https://kratos-shiny.umontana.net/cel-apps/cdmetapopR/patchvars/{.btn .btn-primary target="_blank"}

<!-- -->

-   **Start building a new popVars.csv**\
    [Open App](https://kratos-shiny.umontana.net/cel-apps/cdmetapopR/popvars/){.btn .btn-primary target="_blank"}

<!-- -->

-   **Start building a new runVars.csv**\
    [Open App](https://kratos-shiny.umontana.net/cel-apps/cdmetapopR/runvars/){.btn .btn-primary target="_blank"}
